...
You can discuss bug reports, enhancements and features in our [forum](https://github.com/jesperpedersen/pgprtdbg/discussions).
...
```
git clone git@github.com:yourname/pgprtdbg.git
cd pgprtdbg
